...
<div class="container mt-5">
    <div class="row justify-content-center align-items-center">
        ...
        <input type="Email" name="Email" class="form-control" id="Email" value="{{ $Mahasiswa-
        >email }}" aria-describedby="Email" >
        </div>
        <div class="form-group">
        <label for="Alamat">Alamat</label>
        <input type="Alamat" name="Alamat" class="form-control" id="Alamat" value="{{ $Mahasiswa-
        >alamat }}" aria-describedby="Alamat" >
        </div>
        <div class="form-group">
        <label for="TTL">TTL</label>
        <input type="TTL" name="TTL" class="form-control" id="TTL" value="{{ $Mahasiswa-
        >ttl }}" aria-describedby="TTL" >
        </div>
